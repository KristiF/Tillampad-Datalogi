...
class TestHashtable(unittest.TestCase):
    ...
    def test_replace(self):
        print("\nTestar att kolla om det går att byta ut element i hashtabellen")
        hashtabell = HashTable(10)
        hashtabell.store('nyckel', 'data')
        hashtabell.store('nyckel', 'fel data')
        self.assertNotEqual(hashtabell.search('nyckel'), 'data')
